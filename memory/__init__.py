"""Memory package for evolving-coding-agent.

Provides persistent, file-based memory across conversations.

Storage layout:
  user scope    : ~/.evolving_coding_agent/memory/<slug>.md   (shared across projects)
  project scope : .evolving_coding_agent/memory/<slug>.md     (local to cwd)
